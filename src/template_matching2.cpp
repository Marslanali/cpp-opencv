...
int main(int argc, char **agrv) {
    ...
    cv::Mat final_image(gray_scale_image.rows - gray_scale_filter.rows + 1,
                        gray_scale_image.cols - gray_scale_filter.cols + 1, CV_8UC1);
